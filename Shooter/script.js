...
const points = document.querySelector(".punctuation");
let alienInterval;
let i;
...
function checkLaserColission(laser, alien) {
    ...
    if (laserLeft !== 340 && laserLeft + 40 >= alienLeft) {
        if (laserTop - 10 <= alienTop && laserTop + 10 >= alienBottom) {
            downEnemies();
            return true;
        } else {
            return false;
...
//função que mostra placar
function downEnemies() {
    if (checkLaserColission) {
        i++;
